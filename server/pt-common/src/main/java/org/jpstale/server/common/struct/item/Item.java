...
import org.jpstale.server.common.struct.SocketItem;
import org.jpstale.server.common.struct.UCurMax;
...
public final class Item {
    ...
    public Item() {
        ...
        matureBar = new UCurMax();
        itemAgingProtect = new short[2];
        specialItemType = new short[2];
