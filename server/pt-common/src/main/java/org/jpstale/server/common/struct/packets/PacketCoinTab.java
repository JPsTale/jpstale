...
import lombok.Data;
import org.jpstale.server.common.struct.CoinItem;
...
public class PacketCoinTab extends Packet {
    ...
    /** 本包体字节数（不含包头）. */
    public static final int SIZE_OF = 7692;
    ...
    private CoinItem[] aItems = new CoinItem[30];  // Item aItems[0]  size: 256 * 30 bytes
