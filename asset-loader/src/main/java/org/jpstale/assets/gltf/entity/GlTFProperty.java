...
public class GlTFProperty {
    ...
    /**
     * Add the given extensions. The extensions of this instance will be replaced with a map that contains all previous
    ...
    /**
     * Remove the given extensions. The extensions of this instance will be replaced with a map that contains all
     * previous mappings, except for the one with the given key.<br>
     * If this new map would be empty, then it will be set to <code>null</code>.
     * 
     * @param key The key
