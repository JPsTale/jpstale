...
import org.jpstale.assets.plugins.smd.material.TEXTURE;
...
import org.jpstale.assets.gltf.entity.*;
import org.jpstale.assets.gltf.enums.*;
...
public class Stage2Gltf {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] names = { "Field/forest/fore-1.smd", "Field/forest/fore-2.smd", "Field/forest/fore-3.smd",
				"Field/forest/village-1.smd", "Field/Ricarten/village-2.smd", "Field/Ruin/ruin-4.smd",
				"Field/Ruin/ruin-3.smd", "Field/Ruin/ruin-2.smd", "Field/Ruin/ruin-1.smd",
				"Field/forever-fall/forever-fall-01.smd", "Field/forever-fall/forever-fall-02.smd",
				"Field/forever-fall/forever-fall-03.smd", "Field/forever-fall/forever-fall-04.smd",
				"Field/forever-fall/pilai.smd", "Field/Greedy/Greedy.smd", "Field/desert/De-1.smd",
				"Field/desert/De-2.smd", "Field/desert/De-3.smd", "Field/desert/De-4.smd", "Field/desert/de-5.smd",
				"Field/Sod/sod-1.smd", "Field/Sod/sod-2.smd", "Field/cave/Dcave.smd", "Field/cave/Tcave.smd",
	 ...
	 * 是否使用顶点颜色
	 */
	private boolean isUseVertexColor = false;

	/**
	 * 是否开启光照贴图
	 */
	private boolean isUseLightmap = false;
	...
	private Submesh createSubmeshOld(TreeSet<Integer> faceIds, TreeSet<Integer> vertexIds) {
		...
		if (isUseVertexColor) {
			color = new ColorRGBA[triangles * 3];
		}
