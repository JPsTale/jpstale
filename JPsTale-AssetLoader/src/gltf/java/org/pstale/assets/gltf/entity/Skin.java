...
public class Skin extends GlTFChildOfRootProperty {
     ...
     * matrix is a 4x4 identity matrix, which implies that inverse-bind matrices were pre-applied. (optional)
     * 
     */
    ...
    /**
     * Add the given joints. The joints of this instance will be replaced with a list that contains all previous
    ...
    /**
     * Remove the given joints. The joints of this instance will be replaced with a list that contains all previous
     * elements, except for the removed one.
     * 
     * @param element The element
     * @throws NullPointerException If the given element is <code>null</code>
     * 
