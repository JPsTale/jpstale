...
public class Accessor extends GlTFChildOfRootProperty {
    ...
    /**
     * The offset relative to the start of the bufferView in bytes. (optional)<br>
     * Default: 0<br>
     * Minimum: 0 (inclusive)
     * 
     */
    ...
    /**
     * Specifies whether integer data values should be normalized. (optional)<br>
     * Default: false
     * 
     */
    ...
    /**
     * Sparse storage of attributes that deviate from their initialization value. (optional)
     * 
     */
