...
public class AccessorSparse extends GlTFProperty {
    ...
    /**
     * Index array of size `count` that points to those accessor attributes that deviate from their initialization
     * value. Indices must strictly increase. (required)
     * 
     */
     ...
     * Substituted values must have the same `componentType` and number of components as the base accessor. (required)
     * 
     */
