...
public class AccessorSparseIndices extends GlTFProperty {
    ...
    /**
     * The index of the bufferView with sparse indices. Referenced bufferView can't have ARRAY_BUFFER or
     * ELEMENT_ARRAY_BUFFER target. (required)
     * 
     */
    private Integer bufferView;
    /**
     * The offset relative to the start of the bufferView in bytes. Must be aligned. (optional)<br>
     * Default: 0<br>
     * Minimum: 0 (inclusive)
     * 
     */
